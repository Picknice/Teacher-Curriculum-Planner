...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'path'          => dirname(dirname(__DIR__)) . '/content/',                 // path to files (REQUIRED)
			'URL'           => dirname($_SERVER['PHP_SELF']) . '/../../content/', // URL to files (REQUIRED)
			'trashHash'     => 'Trash',                     // elFinder's hash of trash folder
            ...
            'driver'        => 'LocalFileSystem',           // driver for accessing file system (REQUIRED)
            'path'          => dirname(dirname(__DIR__)) . '/img/',                 // path to files (REQUIRED)
