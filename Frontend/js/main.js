...
function showCalendarConstructor(mode, id, noShowPageCallback)
{
    ...
    var html = `
        <table class="calendar-table-top">
            <tbody>
                <tr class="line">
                    <td class="no-border" width="132px" style="text-align: left;">This shape is a</td>
                    <td colspan="2"></td>
                    <td class="no-border" width="62px" style="padding-right: 5px;">. It has </td>
        ...
        <table class="calendar-table-ex">
            <thead>
                <tr>
                    <th>
                        <div class="th-hint">verb in the past</div>
                        <div class="text underline"></div>
                    </th>
                    <th>
                        <div class="th-hint">verb in the present</div>
                        <div class="text underline"></div>
                    </th>
                    <th>
                        <div class="th-hint">verb in the future</div>
                        <div class="text underline"></div>
                    </th>
                </tr>
            </thead>
...
function calendarPrint(id, list, callback)
{
    html2canvas(document.querySelector(list), {
        ...
        var copyrightHeight = p2mm(40);
        var copyrightWidth = copyrightHeight * 11.66;
        doc.addImage(document.getElementById("copyright"), (doc.internal.pageSize.width - copyrightWidth) / 2, doc.internal.pageSize.height - copyrightHeight - p2mm(5), copyrightWidth, copyrightHeight);
        doc.autoPrint();
